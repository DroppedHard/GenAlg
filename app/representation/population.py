...
class Population:
    def __init__(self, a:int, b:int, func, n_of_variables:int, chrom_length:int, population_size:int, epochs:int, optimization_type:Literal["min", "max"], best_indv_number: int):
        self.a = a
        self.b = b
        self.func = func
